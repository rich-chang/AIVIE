...
public class GenderActivity extends AppCompatActivity {
    ...
    ArrayList<String> gender_db_document = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gender_db_document.add(getString(R.string.firestore_gender_male));
        gender_db_document.add(getString(R.string.firestore_gender_female));
        gender_db_document.add(getString(R.string.firestore_gender_na));
        ...
        docRefUser.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    userData.put(getString(R.string.firestore_users_gender),
                            db.collection(getString(R.string.firestore_gender)).document(gender_db_document.get(selectedIndex)));
